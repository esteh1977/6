...
$header[] = "X-Location: -7.3158".mt_rand(100,999).",112.746".mt_rand(1000,9999);
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
...
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: -6.1753".mt_rand(100,999).",106.827".mt_rand(1000,9999);
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
...
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: -7.8117".mt_rand(100,999).",110.363".mt_rand(1000,9999);
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
...
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: -6.4061".mt_rand(100,999).",106.804".mt_rand(1000,9999);
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
...
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: -6.9174".mt_rand(100,999).",107.619".mt_rand(1000,9999);
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
